...
class Plmi < Formula
  ...
  url "https://github.com/sbwon-uglee/plmi-statusline/archive/refs/tags/v0.6.tar.gz"
  sha256 "c65d39e5c1abe3bd87ba7e91c361aec4b953390da31bf41add7c7df56e70b068"
  ...
  def caveats
    <<~TEXT
      ...
      크기를 고르려면 `plmi --size 36x16`, 뗄 때는 `brew uninstall plmi` 전에 `plmi --uninstall` 을 하세요.
